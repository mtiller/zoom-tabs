export const precipitationSpec = {
  $schema: "https://vega.github.io/schema/vega/v5.json",
  description:
    "A plot of 2016 annual global precipitation data from the NOAA Climate Forecast System (CFS) v2.",
  width: 600,
  height: 300,
  autosize: "fit-x",
  ...
  data: [
    {
      name: "precipitation",
      url: "https://vega.github.io/vega/data/annual-precip.json",
    },
    {
      name: "contours",
